...
class JobCommentsController extends ActiveApiController
{
    public $modelClass = JobComment::class;
    ...
    public function actionIndex($job_id)
    {
        return new ActiveDataProvider([
            'query' => JobComment::find()->where(['job_id' => $job_id])->orderBy(['id' => SORT_DESC]),
        ]);
    }
}
