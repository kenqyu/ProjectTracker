                    ...
                    <table cellpadding="0" cellspacing="0" width="100%" border="0">
                        ...
                        <tr>
                            <td style="word-break:break-word;font-size:0px;padding:10px 25px;" align="left">
                                <div
                                    style="cursor:auto;color:#000000;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:16px;line-height:22px;">
                                    Your registration request has been received and is being reviewed. You will receive a response within 4 business days. <br>
                                    For questions about registration, please contact production@sce.com
                                </div>
                            </td>
                        </tr>
                        </tbody>
